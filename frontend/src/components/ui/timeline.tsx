...
    target: containerRef, 
    // FIX: Changed the end offset from "end 70%" to "end 100%" (or "end end")
    // This ensures the animation covers the full scrollable area of the target element.
    offset: ["start 10%", "end end"], // "end end" means animation finishes when the end of the target hits the end of the viewport
  });
...
        <h2 className="text-4xl md:text-5xl mb-4 text-white max-w-4xl font-black uppercase tracking-widest">
          PROFESSIONAL JOURNEY
        </h2>
        <p className="text-neutral-300 text-sm md:text-base max-w-sm">
          A scrollable timeline of my key certifications, hackathons, and achievements.
        </p>
      </div>
