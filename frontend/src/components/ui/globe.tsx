...
const aspect = 1.0; // FIXED: Changed from 1.2 to 1.0 for perfect sphere
const cameraZ = 300;
...
const GlobeComponent = memo(function GlobeComponent({ globeConfig, data }: WorldProps) {
...
// Memoized WebGL Renderer Config with proper cleanup
const WebGLRendererConfig = memo(function WebGLRendererConfig() {
...
export const World = memo(function World(props: WorldProps) {
  ...
  if (!sceneRef.current) {
    ...
    sceneRef.current.fog = new Fog(0x000000, 400, 2000);
  }
