...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    techStack: ["React", "FastAPI", "TensorFlow", "Supabase", "Tailwind CSS"],
  ...
  },
  {
    ...
    techStack: ["Python", "FastAPI", "React", "Diffusion models"],
  ...
  },
  {
    ...
    role: "Full Stack Developer",
    techStack: ["React", "Flask", "EasyOCR", "Tailwind CSS", "OpenCV"],
      ...
      <div className="relative h-full flex flex-col">
        ...
        <div className={`relative overflow-hidden h-60 rounded-t-3xl`}>
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
            ...
            <div
              className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-lg ${
                project.status === "Live"
            ...
            >
              <div
                className={`w-2 h-2 rounded-full ${
                  project.status === "Live" ? "bg-white" : "bg-black/50"
                } animate-pulse`}
              />
              {project.status}
            </div>
          ...
          <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 scale-90 group-hover:scale-100 z-10">
            <a
              ...
              className="p-2 bg-black/50 backdrop-blur-sm rounded-lg hover:bg-emerald-500 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-black/50 backdrop-blur-sm rounded-lg hover:bg-gray-600 transition-colors"
            >
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {project.techStack.slice(0, 4).map((tech) => (
              <span
                key={tech}
                className="px-3 py-1 bg-emerald-500/10 text-emerald-300 border border-emerald-400/20 rounded-md text-xs font-medium"
              >
                {tech}
              </span>
            ))}
...
const ProjectsSection: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      name: "AI/ML",
      label: "🤖 AI & ML",
      count: projectsData.filter((p) => p.category === "AI/ML").length,
    },
    {
      name: "E-Commerce",
      label: "🛒 E-Commerce",
      count: projectsData.filter((p) => p.category === "E-Commerce").length,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            A curated collection of my work, from intelligent AI applications to
              ...
              <span
                className={`px-2.5 py-0.5 rounded-full text-xs font-bold transition-colors ${
                  filter === category.name
                    ...
                    : "bg-gray-700 text-gray-300 group-hover:bg-emerald-500/50"
                }`}
              >
                {category.count}
              </span>
